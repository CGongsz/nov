...
<head>
    ...
    <link href="${pageContext.request.contextPath }/style/css/login.css" rel="stylesheet">
    <style>
        .form-signin {
            max-width: 330px;
            padding: 15px;
...
<div class="container">
    <form id="loginForm" class="form-signin" action="${pageContext.request.contextPath }/backstage/loginServlet" method="post">
        ...
        <label for="inputUserName" class="sr-only">Acount</label> 
       ...
       <!--  <div class="checkbox">
        ...
        <button id="btnSubmit" class="btn btn-lg btn-primary btn-block" type="button">登录</button>
    </form>
    <div class="container">
