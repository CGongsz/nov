	...
	<script>
		tinymce.init({
		 ...
		 /*  plugins: [
		   ...
		   plugins: [
                'advlist autolink autosave lists link image charmap print preview anchor code',
                'searchreplace visualblocks code fullscreen textcolor colorpicker textpattern code uploadimage',
                'contextmenu paste'
            ],
		  ...
		  toolbar1: "undo redo | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | fontselect fontsizeselect",
            toolbar2: "forecolor backcolor | bullist numlist | outdent indent | removeformat | link unlink uploadimage | preview fullscreen code",
		  menubar: false,
